...
namespace ImGuiNET
{
    public static unsafe partial class ImGui
    {
        ...
        public static ReadOnlySpan<char> GetKeyName(ImGuiKey key)
        {
        ...
        public static ReadOnlySpan<char> GetStyleColorName(ImGuiCol idx)
        {
        ...
        public static ReadOnlySpan<char> SaveIniSettingsToMemory()
        {
            uint* out_ini_size = null;
            byte* ret = ImGuiNative.igSaveIniSettingsToMemory(out_ini_size);
            return Util.StringFromPtr(ret);
        }
        public static ReadOnlySpan<char> SaveIniSettingsToMemory(out uint out_ini_size)
        {
        ...
        public static ReadOnlySpan<char> TableGetColumnName()
        {
            int column_n = -1;
            byte* ret = ImGuiNative.igTableGetColumnName_Int(column_n);
            return Util.StringFromPtr(ret);
        }
        public static ReadOnlySpan<char> TableGetColumnName(int column_n)
        {
            byte* ret = ImGuiNative.igTableGetColumnName_Int(column_n);
            return Util.StringFromPtr(ret);
        }
